...
class Application extends Component {
  ...
  router(route) {
    if (route === "form") {
          ...
          <form onSubmit={this.handleSubmit.bind(this)}>
            ...
            >
              <label
                style={{
                  fontSize: '1.5rem'
                }} className="main-label">Transfer Type</label>
              <input
                type="radio"
              ...
              <label style={{
                fontSize: '1.5rem'
              }} htmlFor="radTransferType_ott">One-Time Transfer</label>
              <br />
              <input
                type="radio"
                name="rad_transferType"
              ...
              <label style={{
                fontSize: '1.5rem'
              }} htmlFor="radTransferType_at">Automatic Transfer</label>
            </fieldset>
            <fieldset
              className={
            ...
            >
              <label style={{
                fontSize: '1.5rem'
              }} className="main-label">Amount</label>
      ...
      return <Home setRoute={this.setRoute.bind(this)} />;
